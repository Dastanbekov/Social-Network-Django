    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Man'), ('W', 'Woman'), ('?', 'Prefer not to say')], default='?', max_length=1, verbose_name='gender')),
                ('birth_date', models.DateField(verbose_name='Birthday')),
                ('about', models.TextField(blank=True, max_length=300, null=True, verbose_name='About person')),
